...
//        val definition1 = defList1?.get(0) as List<*>
//        if (definition1 != null) {
//            binding.senShortDefinition.text =
...
//                3 -> binding.subSenDefEg1.text =
//                    example2List[0].t + "\n" + example2List[1].t + "\n" + example2List[2].t
//
//                in 4..10 -> binding.subSenDefEg1.text =
//                    example2List[0].t + "\n" + example2List[1].t + "\n" + example2List[2].t + "\n" + example2List[3].t
//
...
//        val defList3 = defClass.getDefinitionAtIndex(learnerDataItemList, 3)
//        if (defList3 != null) {
//            val definition3 = defList3?.get(0) as List<*>
//            //Definition 2
//            if (definition3 != null && definition3.isNotEmpty()) {
//                binding.subSenShortDefinition.text =
//                    defClass.replaceBCString(definition3[1].toString())
//            }
//            // Example 3
...
//                    2 -> binding.subSenShortDefEg1.text =
//                        example3List[0].t + "\n" + example3List[1].t
//
//                    3 -> binding.subSenShortDefEg1.text =
//                        example3List[0].t + "\n" + example3List[1].t + "\n" + example3List[2].t
//
//                    in 4..10 -> binding.subSenShortDefEg1.text =
//                        example3List[0].t + "\n" + example3List[1].t + "\n" + example3List[2].t + "\n" + example3List[3].t
//
